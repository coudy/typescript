        ...
        describe("Compiling a project", function (done) {
            ...
            tests.push({
                scenario: "can't find the module"
                    ...
                    , skipRun: true
                    , errors: [
                        TypeScript.switchToForwardSlashes(IO.resolvePath(Harness.userSpecifiedroot)) + '/tests/cases/projects/NoModule/decl.ts(1,25): error TS5008: Cannot resolve imported file: \'./foo/bar.js\'.',
                        TypeScript.switchToForwardSlashes(IO.resolvePath(Harness.userSpecifiedroot)) + '/tests/cases/projects/NoModule/decl.ts(3,25): error TS5008: Cannot resolve imported file: \'./baz\'.']
                });
            ...
            tests.push({
                ...
                , negative: true
                , errors: [
                    TypeScript.switchToForwardSlashes(IO.resolvePath(Harness.userSpecifiedroot)) + '/tests/cases/projects/InvalidReferences/main.ts(1,1): error TS5006: A file cannot reference itself.',
                    TypeScript.switchToForwardSlashes(IO.resolvePath(Harness.userSpecifiedroot)) + '/tests/cases/projects/InvalidReferences/main.ts(2,1): error TS5007: Cannot resolve referenced file: \'nonExistingFile1.ts\'.',
                    TypeScript.switchToForwardSlashes(IO.resolvePath(Harness.userSpecifiedroot)) + '/tests/cases/projects/InvalidReferences/main.ts(3,1): error TS5007: Cannot resolve referenced file: \'nonExistingFile2.ts\'.']
            });
