...
module TypeScript2 {
    ...
    export class DeclarationEmitter implements AstWalkerWithDetailCallback.AstWalkerDetailCallback {
        ...
        private canEmitPrePostAstSignature(declFlags: DeclFlags, astWithPrePostCallback: AST2, preCallback: bool) {
        ...
        private emitDeclarationComments(ast: AST2, endLine?: bool);
        ...
        public DefaultCallback(pre: bool, ast: AST2): bool {
