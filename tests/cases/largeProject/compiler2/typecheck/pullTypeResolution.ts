...
module TypeScript2 {
    ...
    export class PullTypeResolver {
        ...
        public resolveAST(ast: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext) {
            switch (ast.nodeType) {
                case NodeType.ModuleDeclaration:
                case NodeType.InterfaceDeclaration:
                case NodeType.ClassDeclaration:
        ...
        public resolveStatementOrExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext):PullSymbol {
        ...
        public resolveObjectLiteralExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
        ...
        public resolveIndexExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
        ...
        public resolveBitwiseOperator(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
        ...
        public resolveArithmeticExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
            var binex = <BinaryExpression2>expressionAST;
        ...
        public resolveLogicalOrExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
            var binex = <BinaryExpression2>expressionAST;
        ...
        public resolveLogicalAndExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
            var binex = <BinaryExpression2>expressionAST;
        ...
        public resolveCallExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
        ...
        public resolveNewExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
            var callEx = <CallExpression>expressionAST;
        ...
        public resolveTypeAssertionExpression(expressionAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
        ...
        public resolveAssignmentStatement(statementAST: AST2, isTypedAssignment: bool, enclosingDecl: PullDecl, context: PullTypeResolutionContext): PullSymbol {
        ...
        public findMostApplicableSignature(signatures: PullApplicableSignature[], args: ASTList2, enclosingDecl: PullDecl, context: PullTypeResolutionContext): { sig: PullSignatureSymbol; ambiguous: bool; } {
