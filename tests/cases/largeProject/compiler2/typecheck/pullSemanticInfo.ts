...
module TypeScript2 {
    ...
    export class SemanticInfo {
        ...
        public getDeclForAST(ast: AST2) { return <PullDecl>this.astDeclMap.read(ast.getID().toString()); }

        public setDeclForAST(ast: AST2, decl: PullDecl) { this.astDeclMap.link(ast.getID().toString(), decl); }

        public getASTForDecl(decl: PullDecl) { return <AST2>this.declASTMap.read(decl.getDeclID().toString() + decl.getKind().toString()); }

        public setASTForDecl(decl: PullDecl, ast: AST2) { this.declASTMap.link(decl.getDeclID().toString() + decl.getKind().toString(), ast); }
        ...
        public setSymbolForAST(ast: AST2, symbol: PullSymbol) { this.astSymbolMap.link(ast.getID().toString(), symbol);  this.symbolASTMap.link(symbol.getSymbolID().toString(), ast) }
        
        public getSymbolForAST(ast: AST2) { return <PullSymbol>this.astSymbolMap.read(ast.getID().toString()); }

        public getASTForSymbol(symbol: PullSymbol) { return <AST2>this.symbolASTMap.read(symbol.getSymbolID().toString()); }
    ...
    export class SemanticInfoChain {
        ...
        public getDeclForAST(ast: AST2, unitPath: string): PullDecl {
        ...
        public getASTForDecl(decl: PullDecl, unitPath: string): AST2 {
            var unit = <SemanticInfo>this.unitCache[unitPath];
