...
module TypeScript2 {
    export class ScopeChain {
        public thisType: Type2;
        public classType: Type2;
        public fnc: FuncDecl;
    ...
    export class BBUseDefInfo {
        ...
        public initialize(useDefContext: UseDefContext) {
            ...
            var useSym = (sym: Symbol, context: UseDefContext, ast: AST2) => {
                if (context.isLocalSym(sym)) {
            ...
            function initUseDefPre(cur: AST2, parent: AST2, walker: IAstWalker) {
                ...
                if (cur.nodeType == NodeType.VarDecl) {
                    ...
                    if (parent) {
                        if (parent.nodeType == NodeType.Asg) {
                            var asg = <BinaryExpression2>parent;
                            if (asg.operand1 == cur) {
                                return cur;
                            }
                        }
    ...
    export class ControlFlowContext {
        ...
        public walk(ast: AST2, parent: AST2) {
        ...
        private printAST(ast: AST2, outfile: ITextWriter) {
        ...
        public useDef(er: ErrorReporter, funcSym: Symbol) {
            ...
            top.map((index) => {
                var ast = <Identifier2>useDefContext.uses[<number>index];
        ...
        public addUnreachable(ast: AST2) {
            if (this.unreachable === null) {
                this.unreachable = new AST2[];
            }
            this.unreachable[this.unreachable.length] = ast;
        }

        public unconditionalBranch(target: AST2, isContinue: bool) {
            var targetBB = null;
        ...
        public addContent(ast: AST2): void {
            if (this.current) {
    ...
    export class TypeFlow {
        ...
        public regexType: Type2;
        public nullType: Type2;
        public voidType: Type2;
        public arrayAnyType: Type2;

        public arrayInterfaceType: Type2 = null;
        public stringInterfaceType: Type2 = null;
        public objectInterfaceType: Type2 = null;
        public functionInterfaceType: Type2 = null;
        public numberInterfaceType: Type2 = null;
        public booleanInterfaceType: Type2 = null;
        public iargumentsInterfaceType: Type2 = null;
        ...
        constructor (public logger: ILogger2, public initScope: SymbolScope, public parser: Parser,
        ...
        public cast(ast: AST2, type: Type2): AST2 {
            return this.castWithCoercion(ast, type, true, false);
        }

        public castWithCoercion(ast: AST2, type: Type2, applyCoercion: bool, typeAssertion: bool): AST2 {
        ...
        public inScopeTypeCheck(ast: AST2, enclosingScope: SymbolScope): AST2 {
        ...
        public inScopeTypeCheckDecl(ast: AST2) {
                ...
                if (infSym.typeCheckStatus == TypeCheckStatus.Started) {
                    ...
                    if (varDecl.init) {
                        ...
                        if (hasFlag(varDecl.varFlags, VarFlags.Property) && this.thisClassNode) {
                            getAstWalkerFactory().walk(varDecl.init, (ast: AST2, parent: AST2, walker: IAstWalker) => {
        ...
        public typeCheckSuper(ast: AST2): AST2 {
        ...
        public setTypeFromSymbol(ast: AST2, symbol: Symbol): void {
        ...
        public typeCheckScript(script: Script): Script {
            ...
            script.bod = <ASTList2>this.typeCheck(script.bod);
            this.currentScript = null;
            return script;
        }

        public typeCheckBitNot(ast: AST2): AST2 {
            var unex = <UnaryExpression2>ast;
            unex.operand = this.typeCheck(unex.operand);
            unex.type = this.doubleType;
            return unex;
        }

        public typeCheckUnaryNumberOperator(ast: AST2): AST2 {
            var unex = <UnaryExpression2>ast;
            unex.operand = this.typeCheck(unex.operand);
            unex.type = this.doubleType;
            return ast;
        ...
        public typeCheckLogNot(ast: AST2): AST2 {
            var unex = <UnaryExpression2>ast;
            unex.operand = this.typeCheck(unex.operand);
        ...
        public astIsWriteable(ast: AST2): bool {
            return hasFlag(ast.flags, ASTFlags.Writeable);
        }

        public typeCheckIncOrDec(ast: AST2): AST2 {
            var unex = <UnaryExpression2>ast;
            ...
            if (!this.astIsWriteable(unex)) {
                ...
                unex = <UnaryExpression2> this.typeCheckUnaryNumberOperator(ast);
        ...
        public typeCheckBitwiseOperator(ast: AST2, assignment: bool): AST2 {
            var binex = <BinaryExpression2>ast;
        ...
        public typeCheckArithmeticOperator(ast: AST2, assignment: bool): AST2 {
            var binex = <BinaryExpression2>ast;
            binex.operand1 = this.typeCheck(binex.operand1);
            binex.operand2 = this.typeCheck(binex.operand2);
            var leftType = binex.operand1.type;
        ...
        public typeCheckDotOperator(ast: AST2): AST2 {
            var binex = <BinaryExpression2>ast;
            var leftIsFnc = false;
            binex.operand1 = this.typeCheck(binex.operand1);
            var leftType = binex.operand1.type;
            ...
            if (leftScope == null) {
                ...
                var propertyName = <Identifier2>binex.operand2;
        ...
        public typeCheckBooleanOperator(ast: AST2): AST2 {
            var binex = <BinaryExpression2>ast;
            binex.operand1 = this.typeCheck(binex.operand1);
            binex.operand2 = this.typeCheck(binex.operand2);
            var leftType = binex.operand1.type;
        ...
        public typeCheckIndex(ast: AST2): AST2 {
            var binex = <BinaryExpression2>ast;
        ...
        public typeCheckInOperator(binex: BinaryExpression2): BinaryExpression2 {
        ...
        public typeCheckShift(binex: BinaryExpression2, assignment: bool): BinaryExpression2 {
        ...
        // juncture
        public addLocalsFromScope(scope: SymbolScope, container: Symbol, vars: ASTList2, table: IHashTable, isModContainer: bool) {
        ...
        public addConstructorLocalArgs(container: Symbol, args: ASTList2, table: IHashTable, isClass: bool): void {
            if (args) {
        ...
        public classConstructorHasSuperCall(funcDecl: FuncDecl) {
            ...
            var preFindSuperCall = function (ast: AST2, parent: AST2, walker: IAstWalker) {
        ...
        private baseListPrivacyErrorReporter(bases: ASTList2, i: number, declSymbol: Symbol, extendsList: bool, typeName: string, isModuleName: bool) {
        ...
        private typeCheckBaseListPrivacy(bases: ASTList2, declSymbol: Symbol, extendsList: bool) {
            if (bases) {
        ...
        private checkTypePrivacy(type: Type2, declSymbol: Symbol, errorCallback: (typeName: string, isModuleName : bool) =>void ) {
            // Primitive types
        ...
        private returnTypePrivacyError(astError: AST2, funcDecl: FuncDecl, typeName: string, isModuleName: bool) {
            var isGetter = funcDecl.isAccessor() && hasFlag(funcDecl.fncFlags, FncFlags.GetAccessor);
            var isSetter = funcDecl.isAccessor() && hasFlag(funcDecl.fncFlags, FncFlags.SetAccessor);
            var isPublicFunc = hasFlag(funcDecl.fncFlags, FncFlags.Public);
            var isContainerInterface = funcDecl.type.symbol.getInterfaceDeclFromSymbol(this.checker) != null;
        ...
        public typeCheckFunction(funcDecl: FuncDecl): FuncDecl {
            ...
            var targetReturnType: Type2 = null;
            var isGetter = funcDecl.isAccessor() && hasFlag(funcDecl.fncFlags, FncFlags.GetAccessor);
            var isSetter = funcDecl.isAccessor() && hasFlag(funcDecl.fncFlags, FncFlags.SetAccessor);
            var accessorType: Type2 = (isGetter || isSetter) && funcDecl.accessorSymbol ? funcDecl.accessorSymbol.getType() : null;
            ...
            if (funcDecl.bod && (!funcDecl.isSignature())) {
                ...
                if (funcDecl.isConstructor) {
                    var fns: ASTList2 = funcDecl.scopes;
                    var fnsLen = fns.members.length;
                    var freeVars: Symbol[];
                    var sym: Symbol;
                    var j = 0;
            ...
            if (!(fgSym.flags & SymbolFlags.RecursivelyReferenced) && funcDecl.returnStatementsWithExpressions.length > 0) {
                var collection: ITypeCollection = {
                    ...
                    setTypeAtIndex: (index: number, type: Type2) => { funcDecl.returnStatementsWithExpressions[index].type = type; },
        ...
        public typeCheckBases(type: Type2) {
        ...
        public checkMembersImplementInterfaces(implementingType: Type2) {
        ...
        public typeCheckBaseCalls(bases: ASTList2) {
            if (bases == null) {
                return;
            }
            var basesLen = bases.members.length;
        ...
        public assertUniqueNamesInBaseTypes(names: IHashTable, type: Type2, classDecl: InterfaceDeclaration, checkUnique: bool): void {
            if (type) {
                if (type.members) {
        ...
        public checkBaseTypeMemberInheritance(derivedType: Type2, derivedTypeDecl: AST2): void {
        ...
        public typeCheckOverloadSignatures(type: Type2, ast: AST2) {
            if (type.call) {
        ...
        public typeCheckCondExpr(cond: AST2) {
        ...
        public typeCheckCompoundStmtBlock(stmts: AST2, stmtType: string) {
        ...
        public typeCheckObjectLit(objectLit: UnaryExpression2): void {

            var resultType = new Type2();
            ...
            if (memberDecls) {
                for (var i = 0, len = memberDecls.members.length; i < len; i++) {
                    ...
                    var binex = <BinaryExpression2>memberDecls.members[i];
                    ...
                    if (binex.operand2.nodeType == NodeType.FuncDecl && (<FuncDecl>binex.operand2).isAccessor()) {
                        ...
                        if (id.nodeType == NodeType.Name) {
                            (<Identifier2>id).sym = accessorSym;
                        }
                    }
        ...
        public typeCheckArrayLit(arrayLit: UnaryExpression2): void {
            var elements = <ASTList2>arrayLit.operand;
            var elementType = this.anyType;
            var targetElementType: Type2 = null;
            var comparisonInfo = new TypeComparisonInfo();
            ...
            if (elements) {
                ...
                var collection: ITypeCollection = {
                    ...
                    setTypeAtIndex: (index: number, type: Type2) => { elements.members[index].type = type; },
        ...
        public checkForVoidConstructor(type: Type2, ast: AST2) {
            if (type &&
                type.construct &&
        ...
        public typeCheckInstOf(ast: AST2): AST2 {
            var binex = <BinaryExpression2>ast;
            binex.operand1 = this.typeCheck(binex.operand1);
            binex.operand2 = this.typeCheck(binex.operand2);
        ...
        public typeCheckCommaOperator(ast: AST2): AST2 {
            var binex = <BinaryExpression2>ast;
            binex.operand1 = this.typeCheck(binex.operand1);
            binex.operand2 = this.typeCheck(binex.operand2);
        ...
        public typeCheckLogOr(binex: BinaryExpression2): BinaryExpression2 {
            binex.operand1 = this.typeCheck(binex.operand1);
            binex.operand2 = this.typeCheck(binex.operand2);
            var leftType = binex.operand1.type;
            var rightType = binex.operand2.type;
        ...
        public typeCheckLogAnd(binex: BinaryExpression2): BinaryExpression2 {
            binex.operand1 = this.typeCheck(binex.operand1);
            binex.operand2 = this.typeCheck(binex.operand2);
            binex.type = binex.operand2.type;
            return binex;
        ...
        public tryAddCandidates(signature: Signature, actuals: Type2[], exactCandidates: Signature[], conversionCandidates: Signature[], comparisonInfo: TypeComparisonInfo): void {
        ...
        public resolveOverload(application: AST2, group: SignatureGroup): Signature {
        ...
        public typeCheckNew(ast: AST2): AST2 {
            ...
            if (target.type.construct || target.type.call) {
                ...
                callEx.arguments = <ASTList2>this.typeCheck(callEx.arguments);
            }
        ...
        public preTypeCheckCallArgs(args: ASTList2) {
        ...
        public typeCheckCall(ast: AST2): AST2 {
            ...
            if (this.checker.styleSettings.newMustBeUsed && (ast.nodeType == NodeType.New)) {
                ...
                if ((callEx.target.nodeType == NodeType.Name) && ((<Identifier2>callEx.target).text == "eval")) {
        ...
        public findMemberScopeAtFullAst(enclosingScopeContext: EnclosingScopeContext) {
            ...
            var astResult: AST2 = null;

            var preFindMemberScopeFullAst = function (ast: AST2, parent: AST2, walker: IAstWalker) {
            ...
            var preFindMemberScopeFullAstFuzy = function (ast: AST2, parent: AST2, walker: IAstWalker) {
                if (isValidAstNode(ast)) {
