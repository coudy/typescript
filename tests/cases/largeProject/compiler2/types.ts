...
module TypeScript2 {
    ...
    export class Type2 {
        ...
        public getArrayBase(arrInstType: Type2, checker: TypeChecker): Type2 {
    ...
    export interface ITypeCollection {
        ...
        getLength(): number;
        setTypeAtIndex(index: number, type: Type2): void;
        getTypeAtIndex(index: number): Type2;
    }

    export class ModuleType extends Type2 {
        ...
        static findDynamicModuleNameInHashTable(moduleType: Type2, members: IHashTable) {
        ...
        public findDynamicModuleName(moduleType: Type2): { name: string; symbol: Symbol; } {
            var moduleName: { name: string; symbol: Symbol; } = null;
