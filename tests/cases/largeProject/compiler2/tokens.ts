...
module TypeScript2 {
    ...
    export enum Reservation {
        ...
        TypeScriptAndJS = Javascript | TypeScript2,
        TypeScriptAndJSFuture = JavascriptFuture | TypeScript2,
        TypeScriptAndJSFutureStrict = JavascriptFutureStrict | TypeScript2,
    }
    ...
    setTokenInfo(TokenID.Any, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "any", ErrorRecoverySet.PrimType);
    setTokenInfo(TokenID.Bool, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "bool", ErrorRecoverySet.PrimType);
    ...
    setTokenInfo(TokenID.Declare, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "declare", ErrorRecoverySet.Stmt);
    ...
    setTokenInfo(TokenID.Get, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "get", ErrorRecoverySet.Func);
    setTokenInfo(TokenID.Set, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "set", ErrorRecoverySet.Func);
    ...
    setTokenInfo(TokenID.Module, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "module", ErrorRecoverySet.TypeScriptS);
    ...
    setTokenInfo(TokenID.Number, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "number", ErrorRecoverySet.PrimType);
    ...
    setTokenInfo(TokenID.String, Reservation.TypeScript2, OperatorPrecedence.None, NodeType.None, OperatorPrecedence.None, NodeType.None, "string", ErrorRecoverySet.PrimType);
