...
describe("Assignment compatibility", function() {
    ...
    describe("array type", function () {
        ...
        var classArray = typeFactory.get('class Foo {}; var arr = [new Foo()]', 'arr');
    ...
    describe("Objects", function () {
        ...
        describe("Callable properties", function () {
            // TODO: see 622966 for why indexerSigString is included here
            var these = [callObjString, callSigString];
        ...
        var classWithPublic = typeFactory.get('export class Foo1 { constructor(public one: number) {} }; var x = new Foo1(1);', 'x');
        var classWithTwoPublic = typeFactory.get('export class Foo2 { constructor(public one: number, public two: string) {} }; var x = new Foo2(1, "a");', 'x');
        var classWithOptional = typeFactory.get('export class Foo3 { constructor(public one?: number) {} }; var x = new Foo3();', 'x');
        var classWithPublicAndOptional = typeFactory.get('export class Foo4 { constructor(public one: number, public two?: string) {} }; var x = new Foo4(1);', 'x');
        var classWithPrivate = typeFactory.get('export class Foo5 { constructor(private one: number) {} }; var x = new Foo5(1);', 'x');
        var classWithTwoPrivate = typeFactory.get('export class Foo6 { constructor(private one: number, private two: string) {} }; var x = new Foo6(1, "a");', 'x');
        var classWithPublicPrivate = typeFactory.get('export class Foo7 { constructor(public one: number, private two: string) {} }; var x = new Foo7(1, "a");', 'x');

        var interfaceOne = typeFactory.get('export interface I1 { one: number; }; var obj: I1 = { one: 1 };', 'obj');
        var interfaceTwo = typeFactory.get('export interface I2 { one: number; two: string; }; var obj: I2 = { one: 1, two: "a" };', 'obj');
        var interfaceWithOptional = typeFactory.get('export interface I3 { one?: number; }; var obj: I3 = { };', 'obj');
        var interfaceWithPublicAndOptional = typeFactory.get('export interface I4 { one: number; two?: string; }; var obj: I4 = { one: 1 };', 'obj');
        ...
        describe("Classes with properties", function () {
