...
goTo.marker('17');
verify.completionListContains('f1', '(a: number) => number (+ 1 overload(s))', 'this is signature 1', "function");
verify.completionListContains('f2', '(a: number) => number (+ 1 overload(s))', '', "function");
verify.completionListContains('f3', '(a: number) => number (+ 1 overload(s))', '', "function");
verify.completionListContains('f4', '(a: number) => number (+ 1 overload(s))', 'this is signature 4 - with number parameter', "function");

goTo.marker('18');
verify.completionListContains('i1', 'i1', '', "interface");
...
verify.completionListContains('i4', 'i4', '', "interface");
verify.completionListContains('i4_i', 'i4', '', "var");
...
goTo.marker('23');
verify.memberListContains('foo', '(a: number) => number (+ 1 overload(s))', 'foo 1', "method");
verify.memberListContains('foo2', '(a: number) => number (+ 1 overload(s))', '', "method");
verify.memberListContains('foo3', '(a: number) => number (+ 1 overload(s))', '', "method");
verify.memberListContains('foo4', '(a: number) => number (+ 1 overload(s))', 'foo4 1', "method");
...
goTo.marker('44');
verify.memberListContains('prop1', '(a: number) => number (+ 1 overload(s))', '', "method");
verify.memberListContains('prop2', '(a: number) => number (+ 1 overload(s))', 'prop2 1', "method");
verify.memberListContains('prop3', '(a: number) => number (+ 1 overload(s))', '', "method");
verify.memberListContains('prop4', '(a: number) => number (+ 1 overload(s))', 'prop4 1', "method");
verify.memberListContains('prop5', '(a: number) => number (+ 1 overload(s))', 'prop5 1', "method");
...
goTo.marker('65');
verify.completionListContains("c", "new() => c", "", "class");
verify.completionListContains("c1", "{ new(a: number): c1; new(b: string): c1; }", "", "constructor");
verify.completionListContains("c2", "{ new(a: number): c2; new(b: string): c2; }", "", "constructor");
verify.completionListContains("c3", "{ new(a: number): c3; new(b: string): c3; }", "", "constructor");
verify.completionListContains("c4", "{ new(a: number): c4; new(b: string): c4; }", "", "constructor");
verify.completionListContains("c5", "{ new(a: number): c5; new(b: string): c5; }", "", "constructor");
verify.completionListContains("c_i", "c", "", "var");
verify.completionListContains("c1_i_1", "c1", "", "var");
verify.completionListContains("c2_i_1", "c2", "", "var");
verify.completionListContains("c3_i_1", "c3", "", "var");
verify.completionListContains("c4_i_1", "c4", "", "var");
verify.completionListContains("c5_i_1", "c5", "", "var");
verify.completionListContains("c1_i_2", "c1", "", "var");
verify.completionListContains("c2_i_2", "c2", "", "var");
verify.completionListContains("c3_i_2", "c3", "", "var");
verify.completionListContains("c4_i_2", "c4", "", "var");
verify.completionListContains("c5_i_2", "c5", "", "var");
verify.completionListContains('multiOverload', '(a: number) => string (+ 2 overload(s))', 'This is multiOverload F1 1', "function");
verify.completionListContains('ambientF1', '(a: number) => string (+ 2 overload(s))', 'This is ambient F1 1', "function");
