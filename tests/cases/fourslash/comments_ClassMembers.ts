...
goTo.marker('107');
verify.quickInfoIs("{ s1: number; s2(b: number): number; s3: number; s3: number; nc_s1: number; nc_s2(b: number): number; nc_s3: number; nc_s3: number; new(): c1; }", "", "i1_c", "var");
...
verify.completionListContains("i1_c", "{ s1: number; s2(b: number): number; s3: number; s3: number; nc_s1: number; nc_s2(b: number): number; nc_s3: number; nc_s3: number; new(): c1; }", "", "i1_c", "var");
