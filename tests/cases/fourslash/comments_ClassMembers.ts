...
goTo.marker('4');
verify.memberListContains("p1", "number", "p1 is property of c1", "property");
verify.memberListContains("p2", "(b: number) => number", "sum with property", "method");
verify.memberListContains("p3", "number", "getter property\nsetter property", "getter");
verify.memberListContains("pp1", "number", "pp1 is property of c1", "property");
verify.memberListContains("pp2", "(b: number) => number", "sum with property", "method");
verify.memberListContains("pp3", "number", "getter property\nsetter property", "getter");
verify.memberListContains("nc_p1", "number", "", "property");
verify.memberListContains("nc_p2", "(b: number) => number", "", "method");
verify.memberListContains("nc_p3", "number", "", "getter");
verify.memberListContains("nc_pp1", "number", "", "property");
verify.memberListContains("nc_pp2", "(b: number) => number", "", "method");
verify.memberListContains("nc_pp3", "number", "", "getter");

goTo.marker('5');
verify.completionListContains("b", "number", "number to add", "(parameter)");
...
verify.currentSignatureHelpDocCommentIs("sum with property");
verify.currentParameterHelpArgumentDocCommentIs("number to add");
verify.completionListContains("value", "number", "this is value", "(parameter)");
...
goTo.marker('29');
verify.completionListContains("c1", "{ s1: number; s2(b: number): number; s3: number; nc_s1: number; nc_s2(b: number): number; nc_s3: number; new(): c1; }", "This is comment for c1", "constructor");

goTo.marker('30');
verify.memberListContains("s1", "number", "s1 is static property of c1", "property");
verify.memberListContains("s2", "(b: number) => number", "static sum with property", "method");
verify.memberListContains("s3", "number", "static getter property\nsetter property", "getter");
verify.memberListContains("nc_s1", "number", "", "property");
verify.memberListContains("nc_s2", "(b: number) => number", "", "method");
verify.memberListContains("nc_s3", "number", "", "getter");
...
goTo.marker('45');
verify.completionListContains("b", "number", "", "(parameter)");
...
verify.currentSignatureHelpDocCommentIs("");
verify.currentParameterHelpArgumentDocCommentIs("");
verify.completionListContains("value", "number", "", "(parameter)");
...
goTo.marker('109');
verify.completionListContains("c1", "{ s1: number; s2(b: number): number; s3: number; nc_s1: number; nc_s2(b: number): number; nc_s3: number; new(): c1; }", "This is comment for c1", "constructor");
verify.completionListContains("i1", "c1", "", "var");
verify.completionListContains("i1_p", "number", "", "var");
verify.completionListContains("i1_f", "(b: number) => number", "", "var");
verify.completionListContains("i1_r", "number", "", "var");
verify.completionListContains("i1_prop", "number", "", "var");
verify.completionListContains("i1_nc_p", "number", "", "var");
verify.completionListContains("i1_ncf", "(b: number) => number", "", "var");
verify.completionListContains("i1_ncr", "number", "", "var");
verify.completionListContains("i1_ncprop", "number", "", "var");
verify.completionListContains("i1_s_p", "number", "", "var");
verify.completionListContains("i1_s_f", "(b: number) => number", "", "var");
verify.completionListContains("i1_s_r", "number", "", "var");
verify.completionListContains("i1_s_prop", "number", "", "var");
verify.completionListContains("i1_s_nc_p", "number", "", "var");
verify.completionListContains("i1_s_ncf", "(b: number) => number", "", "var");
verify.completionListContains("i1_s_ncr", "number", "", "var");
verify.completionListContains("i1_s_ncprop", "number", "", "var");
verify.completionListContains("i1_c", "{ s1: number; s2(b: number): number; s3: number; nc_s1: number; nc_s2(b: number): number; nc_s3: number; new(): c1; }", "", "var");

goTo.marker('110');
verify.quickInfoIs("number");
verify.memberListContains("p1", "number", "getter only property", "getter");
verify.memberListContains("p2", "number", "setter only property", "setter");
verify.memberListContains("nc_p1", "number", "", "getter");
verify.memberListContains("nc_p2", "number", "", "setter");
...
goTo.marker('114');
verify.memberListContains("a", "number", "this is first parameter a\nmore info about a", "property");

goTo.marker('115');
verify.completionListContains("a", "number", "this is first parameter a\nmore info about a", "(parameter)");
