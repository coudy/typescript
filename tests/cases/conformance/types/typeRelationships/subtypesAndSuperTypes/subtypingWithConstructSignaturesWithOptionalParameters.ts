...
interface I6 extends Base {
    a2: new (x: number) => number; // error, too many required params
}
...
interface I14 extends Base {
    a4: new (x: number, y: number) => number;  // error, too many required params
}
...
interface I17 extends Base {
    a5: new (x: number) => number; // error, too many required params
}

interface I18 extends Base {
    a5: new (x: number, y: number) => number;  // error, too many required params
}