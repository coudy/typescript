...
verify.completionListContains("c1", "new() => c1", "", "c1", "class");
...
verify.quickInfoIs("new(a: number) => c2", "", "c2", "class");
...
verify.memberListContains("prop", "number", "c3 prop", "c3.prop", "getter");
verify.memberListContains("nc_p1", "number", "", "c3.nc_p1", "property");
verify.memberListContains("nc_f1", "() => void", "", "c3.nc_f1", "method");
verify.memberListContains("nc_prop", "number", "", "c3.nc_prop", "getter");
goTo.marker('25');
verify.currentSignatureHelpDocCommentIs("c2 c2_f1");
goTo.marker('26');
verify.currentSignatureHelpDocCommentIs("");
...
goTo.marker('35');
verify.completionListContains("c2", "new(a: number) => c2", "", "c2", "class");
...
verify.completionListContains("c4", "new(a: number) => c4", "", "c4", "class");
...
goTo.marker('53');
verify.quickInfoIs("new() => c5", "c5 class", "c5", "class");
