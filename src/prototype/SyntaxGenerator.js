...
var ModuleDeclarationSyntax = (function (_super) {
    ...
    function ModuleDeclarationSyntax(exportKeyword, declareKeyword, moduleKeyword, moduleName, stringLiteral, openBraceToken, moduleElements, closeBraceToken) {
        ...
        if(stringLiteral !== null && stringLiteral.kind() !== 10 /* StringLiteral */ ) {
            throw Errors.argument('stringLiteral');
        }
        if(openBraceToken.kind() !== 65 /* OpenBraceToken */ ) {
            throw Errors.argument('openBraceToken');
...
var PrefixUnaryExpressionSyntax = (function (_super) {
    ...
    function PrefixUnaryExpressionSyntax(kind, operatorToken, operand) {
        ...
        if(operatorToken.kind() !== 88 /* PlusPlusToken */  && operatorToken.kind() !== 89 /* MinusMinusToken */  && operatorToken.kind() !== 84 /* PlusToken */  && operatorToken.kind() !== 85 /* MinusToken */  && operatorToken.kind() !== 97 /* TildeToken */  && operatorToken.kind() !== 96 /* ExclamationToken */ ) {
...
var LiteralExpressionSyntax = (function (_super) {
    ...
    function LiteralExpressionSyntax(kind, literalToken) {
        ...
        if(literalToken.kind() !== 8 /* RegularExpressionLiteral */  && literalToken.kind() !== 10 /* StringLiteral */  && literalToken.kind() !== 9 /* NumericLiteral */  && literalToken.keywordKind() !== 20 /* FalseKeyword */  && literalToken.keywordKind() !== 33 /* TrueKeyword */  && literalToken.keywordKind() !== 28 /* NullKeyword */ ) {
...
var ParameterSyntax = (function (_super) {
    ...
    function ParameterSyntax(dotDotDotToken, publicOrPrivateKeyword, identifier, questionToken, typeAnnotation, equalsValueClause) {
        _super.call(this);
        if(dotDotDotToken !== null && dotDotDotToken.kind() !== 72 /* DotDotDotToken */ ) {
            throw Errors.argument('dotDotDotToken');
        }
        if(publicOrPrivateKeyword !== null && publicOrPrivateKeyword.keywordKind() !== 53 /* PublicKeyword */  && publicOrPrivateKeyword.keywordKind() !== 51 /* PrivateKeyword */ ) {
            throw Errors.argument('publicOrPrivateKeyword');
        }
        if(identifier.kind() !== 7 /* IdentifierNameToken */ ) {
            throw Errors.argument('identifier');
        }
        if(questionToken !== null && questionToken.kind() !== 100 /* QuestionToken */ ) {
...
var BinaryExpressionSyntax = (function (_super) {
    ...
    function BinaryExpressionSyntax(kind, left, operatorToken, right) {
        ...
        if(operatorToken.kind() !== 86 /* AsteriskToken */  && operatorToken.kind() !== 113 /* SlashToken */  && operatorToken.kind() !== 87 /* PercentToken */  && operatorToken.kind() !== 84 /* PlusToken */  && operatorToken.kind() !== 85 /* MinusToken */  && operatorToken.kind() !== 90 /* LessThanLessThanToken */  && operatorToken.kind() !== 91 /* GreaterThanGreaterThanToken */  && operatorToken.kind() !== 92 /* GreaterThanGreaterThanGreaterThanToken */  && operatorToken.kind() !== 75 /* LessThanToken */  && operatorToken.kind() !== 76 /* GreaterThanToken */  && operatorToken.kind() !== 77 /* LessThanEqualsToken */  && operatorToken.kind() !== 78 /* GreaterThanEqualsToken */  && operatorToken.keywordKind() !== 26 /* InstanceOfKeyword */  && operatorToken.keywordKind() !== 25 /* InKeyword */  && operatorToken.kind() !== 79 /* EqualsEqualsToken */  && operatorToken.kind() !== 81 /* ExclamationEqualsToken */  && operatorToken.kind() !== 82 /* EqualsEqualsEqualsToken */  && operatorToken.kind() !== 83 /* ExclamationEqualsEqualsToken */  && operatorToken.kind() !== 93 /* AmpersandToken */  && operatorToken.kind() !== 95 /* CaretToken */  && operatorToken.kind() !== 94 /* BarToken */  && operatorToken.kind() !== 98 /* AmpersandAmpersandToken */  && operatorToken.kind() !== 99 /* BarBarToken */  && operatorToken.kind() !== 111 /* BarEqualsToken */  && operatorToken.kind() !== 110 /* AmpersandEqualsToken */  && operatorToken.kind() !== 112 /* CaretEqualsToken */  && operatorToken.kind() !== 107 /* LessThanLessThanEqualsToken */  && operatorToken.kind() !== 108 /* GreaterThanGreaterThanEqualsToken */  && operatorToken.kind() !== 109 /* GreaterThanGreaterThanGreaterThanEqualsToken */  && operatorToken.kind() !== 103 /* PlusEqualsToken */  && operatorToken.kind() !== 104 /* MinusEqualsToken */  && operatorToken.kind() !== 105 /* AsteriskEqualsToken */  && operatorToken.kind() !== 114 /* SlashEqualsToken */  && operatorToken.kind() !== 106 /* PercentEqualsToken */  && operatorToken.kind() !== 102 /* EqualsToken */  && operatorToken.kind() !== 74 /* CommaToken */ ) {
            throw Errors.argument('operatorToken');
        }
        this._kind = kind;
        this._left = left;
...
var MemberFunctionDeclarationSyntax = (function (_super) {
    ...
    function MemberFunctionDeclarationSyntax(publicOrPrivateKeyword, staticKeyword, functionSignature, block, semicolonToken) {
        ...
        if(staticKeyword !== null && staticKeyword.keywordKind() !== 54 /* StaticKeyword */ ) {
...
var BreakStatementSyntax = (function (_super) {
    ...
    function BreakStatementSyntax(breakKeyword, identifier, semicolonToken) {
        ...
        if(identifier !== null && identifier.kind() !== 7 /* IdentifierNameToken */ ) {
            throw Errors.argument('identifier');
        }
        if(semicolonToken.kind() !== 73 /* SemicolonToken */ ) {
            throw Errors.argument('semicolonToken');
