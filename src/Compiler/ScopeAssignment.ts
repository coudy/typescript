...
module TypeScript {
    ...
    export function preAssignWithScopes(ast: AST, context: AssignScopeContext) {
        ...
        withType = new Type();
        var withSymbol = new WithSymbol(withStmt.minChar, null /*context.typeFlow.checker.locationInfo.fileName*/, withType, context.typeFlow.compilationSettings.optimizeModuleCodeGen);
