...
module TypeScript {
    export var DiagnosticCode = {
        ...
        this_must_only_be_used_inside_a_function_or_script_context: "'this' must only be used inside a function or script context.",
        ...
        this_cannot_be_referenced_in_initializers_in_a_class_body: "'this' cannot be referenced in initializers in a class body.",
        ...
        Current_host_does_not_support_w_atch_option: "Current host does not support -w[atch] option.",
        ...
        Generates_corresponding_map_file: "Generates corresponding .map file",
        Writes_the_full_path_of_map_file_in_the_generated_js_file: "Writes the full path of map file in the generated js file",
        Generates_corresponding_d_ts_file: "Generates corresponding .d.ts file",
        ...
        Do_not_include_a_default_lib_d_ts_with_global_declarations: "Do not include a default lib.d.ts with global declarations",
        ...
        Specify_ECMAScript_target_version_ES3_default_or_ES5: "Specify ECMAScript target version: \"ES3\" (default), or \"ES5\"",
        Specify_module_code_generation_commonjs_default_or_amd: "Specify module code generation: \"commonjs\" (default) or \"amd\"",
        ...
        Allow_use_of_deprecated_bool_type: "Allow use of deprecated \"bool\" type",
        Allow_use_of_deprecated_module_keyword_when_referencing_an_external_module: "Allow use of deprecated \"module\" keyword when referencing an external module",
        Specify_locale_for_errors_and_messages_For_example_en_or_ja_jp: "Specify locale for errors and messages. For example 'en' or 'ja-jp'",
        Syntax_0: "Syntax:   {0}",
        options: "options",
        file: "file",
