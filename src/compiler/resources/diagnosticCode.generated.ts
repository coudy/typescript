...
module TypeScript {
    export var DiagnosticCode = {
        ...
        Parameter_of_a_catch_clause_cannot_have_a_type_annotation: "Parameter of a catch clause cannot have a type annotation.",
        ...
        Classes_can_only_extend_a_single_type: "Classes can only extend a single type.",
        ...
        Parameter_properties_can_only_be_used_in_constructors: "Parameter properties can only be used in constructors.",
        ...
        Accessors_are_only_available_when_targeting_ECMAScript_5_0_and_higher: "Accessors are only available when targeting ECMAScript 5.0 and higher.",
        ...
        Unable_to_invoke_an_expression_whose_type_lacks_a_call_signature: "Unable to invoke an expression whose type lacks a call signature.",
