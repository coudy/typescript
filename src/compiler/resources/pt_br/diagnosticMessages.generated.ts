// <auto-generated />
module TypeScript {
    export var diagnosticMessages_pt_br = {
        "error TS{0}: {1}": "error TS{0}: {1}",
        "warning TS{0}: {1}": "warning TS{0}: {1}",
        "{0}{NL}{{1}TB}{2}": "{0}{NL}{{1}TB}{2}",
        "{{0}TB}{1}": "{{0}TB}{1}",
        ...
        "Tried to set variable type to container type '{0}'.": "Tried to set variable type to container type '{0}'.",
        ...
        "Type reference cannot must refer to type.": "Type reference cannot must refer to type.",
