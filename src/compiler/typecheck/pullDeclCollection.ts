...
module TypeScript {
    ...
    function preCollectImportDecls(ast: AST, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(importDecl.identifier.valueText(), importDecl.identifier.actualText, PullElementKind.TypeAlias, declFlags, parent, span);
    ...
    function createEnumElementDecls(propertyDecl: EnumElement, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(propertyDecl.identifier.valueText(), propertyDecl.identifier.actualText, declType, declFlags, parent, span);
    ...
    function preCollectClassDecls(classDecl: ClassDeclaration, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(classDecl.identifier.valueText(), classDecl.identifier.actualText, PullElementKind.Class, declFlags, parent, span);

        var constructorDecl = new NormalPullDecl(classDecl.identifier.valueText(), classDecl.identifier.actualText, constructorDeclKind, declFlags | PullElementFlags.ClassConstructorVariable, parent, span);
    ...
    function preCollectInterfaceDecls(interfaceDecl: InterfaceDeclaration, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(interfaceDecl.identifier.valueText(), interfaceDecl.identifier.actualText, PullElementKind.Interface, declFlags, parent, span);
    ...
    function preCollectParameterDecl(argDecl: Parameter, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(argDecl.id.valueText(), argDecl.id.actualText, PullElementKind.Parameter, declFlags, parent, span);
        ...
        if (isPublicOrPrivate && isInConstructor) {
            ...
            var propDecl = new NormalPullDecl(argDecl.id.valueText(), argDecl.id.actualText, PullElementKind.Property, declFlags, parentsParent, span);
    ...
    function preCollectTypeParameterDecl(typeParameterDecl: TypeParameter, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(typeParameterDecl.name.valueText(), typeParameterDecl.name.actualText, PullElementKind.TypeParameter, declFlags, parent, span);
    ...
    function createPropertySignature(propertyDecl: VariableDeclarator, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(propertyDecl.id.valueText(), propertyDecl.id.actualText, declType, declFlags, parent, span);
        context.semanticInfoChain.setDeclForAST(propertyDecl, decl);
        context.semanticInfoChain.setASTForDecl(decl, propertyDecl);
    ...
    function createMemberVariableDeclaration(memberDecl: MemberVariableDeclaration, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(memberDecl.id.valueText(), memberDecl.id.actualText, declType, declFlags, parent, span);
    ...
    function createVariableDeclaration(varDecl: VariableDeclarator, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(varDecl.id.valueText(), varDecl.id.actualText, declType, declFlags, parent, span);
    ...
    function createFunctionDeclaration(funcDeclAST: FunctionDeclaration, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(funcDeclAST.name.valueText(), funcDeclAST.name.actualText, declType, declFlags, parent, span);
    ...
    function createAnyMemberFunctionDeclaration(memberFunctionDeclAST: AST, flags: FunctionFlags, name: Identifier, block: Block, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(name.valueText(), name.actualText, declType, declFlags, parent, span);
    ...
    function createGetAccessorDeclaration(getAccessorDeclAST: GetAccessor, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(getAccessorDeclAST.propertyName.valueText(), getAccessorDeclAST.propertyName.actualText, declType, declFlags, parent, span);
    ...
    function createSetAccessorDeclaration(setAccessorDeclAST: SetAccessor, context: DeclCollectionContext): void {
        ...
        var decl = new NormalPullDecl(setAccessorDeclAST.propertyName.valueText(), setAccessorDeclAST.propertyName.actualText, declType, declFlags, parent, span);
