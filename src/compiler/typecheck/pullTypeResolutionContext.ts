...
module TypeScript {
    ...
    export class PullTypeResolutionContext {
        ...
        private typeSpecializationStack: any[] = [];
        private genericASTResolutionStack: AST[] = [];
        private emptySpecializationCache: any = {};
        ...
        public addEmptySpecialization(type: PullTypeSymbol) {
            this.emptySpecializationCache[type.getSymbolID().toString()] = type;
        }

        public hasEmptySpecialization(type: PullTypeSymbol) {
            return !!this.emptySpecializationCache[type.getSymbolID().toString()];
        }

        public removeEmptySpecialization(type: PullTypeSymbol) {
            if (this.emptySpecializationCache[type.getSymbolID().toString()]) {
                this.emptySpecializationCache[type.getSymbolID().toString()] = undefined;
            }
        }
    }
}