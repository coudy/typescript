...
module TypeScript {
    ...
    export class ContextualTypingContextStack {
        ...
        public pushContextualType(type: Type, provisional: boolean) { this.contextStack.push(new ContextualTypeContext(type, provisional, ContextualTypingContextStack.contextID++)); this.checker.errorReporter.pushToErrorSink = provisional; }
    ...
    export class TypeChecker {
        ...
        // Contextual typing
        public setContextualType(type: Type, provisional: boolean) {
        ...
        public typeCheckWithContextualType(contextType: Type, provisional: boolean, condition: boolean, ast: AST) {
            if (condition) {
        ...
        public createAccessorSymbol(funcDecl: FunctionDeclaration, fgSym: Symbol, enclosingClass: Type, addToMembers: boolean, isClassProperty: boolean, scope: SymbolScope, container: Symbol) {
        ...
        public findMostApplicableSignature(signatures: ApplicableSignature[], args: ASTList): { sig: Signature; ambiguous: boolean; } {
